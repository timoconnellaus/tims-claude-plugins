---
topic: ink/community/ink-multi-select
title: ink-multi-select [](https://travis-ci.org/karaggeorge/ink-multi-select)
description: Multi-Select input component for Ink
version: latest
sourceUrl: https://github.com/karaggeorge/ink-multi-select
tags:
  - ink
  - community
  - component
