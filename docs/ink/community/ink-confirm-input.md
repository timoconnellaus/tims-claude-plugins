---
topic: ink/community/ink-confirm-input
title: ink-confirm-input [](https://travis-ci.org/kevva/ink-confirm-input)
description: Confirmation input component for Ink
version: latest
sourceUrl: https://github.com/kevva/ink-confirm-input
tags:
  - ink
  - community
  - component
