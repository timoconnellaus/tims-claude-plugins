---
topic: ink/community/ink-use-stdout-dimensions
title: ink-use-stdout-dimensions
description: React hook for subscribing to stdout dimensions in Ink
version: latest
sourceUrl: https://github.com/cameronhunter/ink-monorepo
tags:
  - ink
  - community
  - hook
