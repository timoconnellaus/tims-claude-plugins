---
topic: ink/community/ink-task-list
title: ink-task-list <a href="https://npm.im/ink-task-list"><img
  src="https://badgen.net/npm/v/ink-task-list"></a> <a
  href="https://npm.im/ink-task-list"><img
  src="https://badgen.net/npm/dm/ink-task-list"></a> <a
  href="https://packagephobia.now.sh/result?p=ink-task-list"><img
  src="https://packagephobia.now.sh/badge?p=ink-task-list"></a>
description: Task list components for Ink
version: latest
sourceUrl: https://github.com/privatenumber/ink-task-list
tags:
  - ink
  - community
  - component
