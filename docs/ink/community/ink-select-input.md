---
topic: ink/community/ink-select-input
title: ink-select-input [](https://github.com/vadimdemedes/ink-select-input/actions)
description: Select input component for Ink
version: latest
sourceUrl: https://github.com/vadimdemedes/ink-select-input
tags:
  - ink
  - community
  - component
