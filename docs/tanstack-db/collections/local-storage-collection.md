---
topic: tanstack-db/collections/local-storage-collection
title: LocalStorage Collection
description: LocalStorage collections store small amounts of local-only state
  that persists across browser sessions and syncs across browser tabs in
  real-time.
version: beta
sourceUrl: https://github.com/tanstack/db/blob/main/docs/collections/local-storage-collection.md
tags:
  - tanstack-db
  - collections
---
