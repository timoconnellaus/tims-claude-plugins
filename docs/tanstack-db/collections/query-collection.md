---
topic: tanstack-db/collections/query-collection
title: Query Collection
description: Query collections provide seamless integration between TanStack DB
  and TanStack Query, enabling automatic synchronization between your local
  database and remote data sources.
version: beta
sourceUrl: https://github.com/tanstack/db/blob/main/docs/collections/query-collection.md
tags:
  - tanstack-db
  - collections
---
