---
topic: tanstack-db/collections/local-only-collection
title: LocalOnly Collection
description: LocalOnly collections are designed for in-memory client data or UI
  state that doesn't need to persist across browser sessions or sync across
  tabs.
version: beta
sourceUrl: https://github.com/tanstack/db/blob/main/docs/collections/local-only-collection.md
tags:
  - tanstack-db
  - collections
---
