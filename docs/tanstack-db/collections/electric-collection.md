---
topic: tanstack-db/collections/electric-collection
title: Electric Collection
description: Electric collections provide seamless integration between TanStack
  DB and ElectricSQL, enabling real-time data synchronization with your Postgres
  database through Electric's sync engine.
version: beta
sourceUrl: https://github.com/tanstack/db/blob/main/docs/collections/electric-collection.md
tags:
  - tanstack-db
  - collections
---
