---
topic: tanstack-db/guides/collection-options-creator
title: Creating a Collection Options Creator
description: A collection options creator is a factory function that generates
  configuration options for TanStack DB collections. It provides a standardized
  way to integrate different sync engines and data sources
version: beta
sourceUrl: https://github.com/tanstack/db/blob/main/docs/guides/collection-options-creator.md
tags:
  - tanstack-db
  - guides
---
