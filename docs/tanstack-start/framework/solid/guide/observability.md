---
topic: tanstack-start/framework/solid/guide/observability
title: Observability
...
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/solid/guide/observability.md
tags:
  - tanstack-start
  - framework
---
