---
topic: tanstack-start/framework/solid/guide/server-routes
title: Server Routes
description: Server routes are a powerful feature of TanStack Start that allow
  you to create server-side endpoints in your application and are useful for
  handling raw HTTP requests, form submissions, user authenti
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/solid/guide/server-routes.md
tags:
  - tanstack-start
  - framework
---
