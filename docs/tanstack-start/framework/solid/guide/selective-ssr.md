---
topic: tanstack-start/framework/solid/guide/selective-ssr
title: Selective Ssr
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/solid/guide/selective-ssr.md
tags:
  - tanstack-start
  - framework
---
