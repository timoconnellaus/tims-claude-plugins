---
topic: tanstack-start/framework/solid/guide/tailwind-integration
...
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/solid/guide/tailwind-integration.md
tags:
  - tanstack-start
  - framework
---
