---
topic: tanstack-start/framework/solid/guide/execution-model
...
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/solid/guide/execution-model.md
tags:
  - tanstack-start
  - framework
---
