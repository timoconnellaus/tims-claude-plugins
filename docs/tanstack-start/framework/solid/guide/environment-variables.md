---
topic: tanstack-start/framework/solid/guide/environment-variables
title: .env
description: Learn how to securely configure and use environment variables in
  your TanStack Start application across different contexts (server functions,
  client code, and build processes).
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/solid/guide/environment-variables.md
tags:
  - tanstack-start
  - framework
---
