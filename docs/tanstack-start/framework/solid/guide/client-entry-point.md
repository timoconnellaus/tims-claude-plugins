---
topic: tanstack-start/framework/solid/guide/client-entry-point
title: Client Entry Point
description: "> [!NOTE] > The client entry point is **optional** out of the box.
  If not provided, TanStack Start will automatically handle the client entry
  point for you using the below as a default."
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/solid/guide/client-entry-point.md
tags:
  - tanstack-start
  - framework
---
