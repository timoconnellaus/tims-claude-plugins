---
topic: tanstack-start/framework/solid/guide/authentication
title: Authentication
description: This guide covers authentication patterns and shows how to
  implement your own authentication system with TanStack Start. > **📋 Before
  You Start:** Check our [Authentication Overview](./authentication
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/solid/guide/authentication.md
tags:
  - tanstack-start
  - framework
---
