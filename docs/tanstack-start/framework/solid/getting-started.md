---
topic: tanstack-start/framework/solid/getting-started
title: Getting Started
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/solid/getting-started.md
tags:
  - tanstack-start
  - framework
---
