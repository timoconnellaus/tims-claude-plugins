---
topic: tanstack-start/framework/solid/build-from-scratch
title: Build From Scratch
description: "> [!NOTE] > If you chose to quick start with an example or cloned
  project, you can skip this guide and move on to the [Routing](./guide/routing)
  guide. _So you want to build a TanStack Start project f"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/solid/build-from-scratch.md
tags:
  - tanstack-start
  - framework
---
