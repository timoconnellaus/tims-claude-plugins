---
topic: tanstack-start/framework/react/guide/static-server-functions
title: Static Server Functions
description: "> [!WARNING] > Static Server Functions are experimental!"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/guide/static-server-functions.md
tags:
  - tanstack-start
  - framework
---
