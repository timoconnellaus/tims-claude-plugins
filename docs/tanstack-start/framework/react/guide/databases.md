---
topic: tanstack-start/framework/react/guide/databases
title: Databases
description: Databases are at the core of any dynamic application, providing the
  necessary infrastructure to store, retrieve, and manage data. TanStack Start
  makes it easy to integrate with a variety of databases,
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/guide/databases.md
tags:
  - tanstack-start
  - framework
---
