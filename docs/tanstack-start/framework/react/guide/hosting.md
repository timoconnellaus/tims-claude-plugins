---
topic: tanstack-start/framework/react/guide/hosting
title: or...
description: "Hosting is the process of deploying your application to the
  internet so that users can access it. This is a critical part of any web
  development project, ensuring your application is available to the "
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/guide/hosting.md
tags:
  - tanstack-start
  - framework
---
