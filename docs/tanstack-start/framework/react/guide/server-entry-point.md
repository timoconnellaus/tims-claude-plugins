---
topic: tanstack-start/framework/react/guide/server-entry-point
title: Server Entry Point
description: "> [!NOTE] > The server entry point is **optional** out of the box.
  If not provided, TanStack Start will automatically handle the server entry
  point for you using the below as a default."
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/guide/server-entry-point.md
tags:
  - tanstack-start
  - framework
---
