---
topic: tanstack-start/framework/react/guide/server-functions
title: Server Functions
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/guide/server-functions.md
tags:
  - tanstack-start
  - framework
---
