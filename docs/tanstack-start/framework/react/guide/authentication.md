---
topic: tanstack-start/framework/react/guide/authentication
...
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/guide/authentication.md
tags:
  - tanstack-start
  - framework
---
