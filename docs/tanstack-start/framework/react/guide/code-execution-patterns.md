---
topic: tanstack-start/framework/react/guide/code-execution-patterns
...
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/guide/code-execution-patterns.md
tags:
  - tanstack-start
  - framework
---
