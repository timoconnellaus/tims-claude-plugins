---
topic: tanstack-start/framework/react/guide/spa-mode
title: Catch all other 404 requests and rewrite them to the SPA shell
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/guide/spa-mode.md
tags:
  - tanstack-start
  - framework
---
