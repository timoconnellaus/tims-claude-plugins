---
topic: tanstack-start/framework/react/guide/streaming-data-from-server-functions
title: Streaming Data From Server Functions
description: "Streaming data from the server has become very popular thanks to
  the rise of AI apps. Luckily, it's a pretty easy task with TanStack Start, and
  what's even better: the streamed data is typed! The two "
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/guide/streaming-data-from-server-functions.md
tags:
  - tanstack-start
  - framework
---
