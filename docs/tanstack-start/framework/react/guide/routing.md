---
topic: tanstack-start/framework/react/guide/routing
title: Routing
description: TanStack Start is built on top of TanStack Router, so all of the
  features of TanStack Router are available to you. > [!NOTE] > We highly
  recommend reading the [TanStack Router documentation](/router/l
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/guide/routing.md
tags:
  - tanstack-start
  - framework
---
