---
topic: tanstack-start/framework/react/guide/path-aliases
title: Path Aliases
description: Path aliases are a useful feature of TypeScript that allows you to
  define a shortcut for a path that could be distant in your project's directory
  structure. This can help you avoid long relative impor
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/guide/path-aliases.md
tags:
  - tanstack-start
  - framework
---
