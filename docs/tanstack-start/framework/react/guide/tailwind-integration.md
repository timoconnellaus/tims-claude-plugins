---
topic: tanstack-start/framework/react/guide/tailwind-integration
title: Tailwind Integration
description: _So you want to use Tailwind CSS in your TanStack Start project?_
  This guide will help you use Tailwind CSS in your TanStack Start project.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/guide/tailwind-integration.md
tags:
  - tanstack-start
  - framework
---
