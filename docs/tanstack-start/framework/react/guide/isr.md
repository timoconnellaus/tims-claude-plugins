---
topic: tanstack-start/framework/react/guide/isr
title: public/_headers
description: Incremental Static Regeneration (ISR) allows you to serve
  statically generated content from a CDN while periodically regenerating it in
  the background. This gives you the performance benefits of stati
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/guide/isr.md
tags:
  - tanstack-start
  - framework
---
