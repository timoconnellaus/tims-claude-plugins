---
topic: tanstack-start/framework/react/guide/server-routes
title: Server Routes
...
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/guide/server-routes.md
tags:
  - tanstack-start
  - framework
---
