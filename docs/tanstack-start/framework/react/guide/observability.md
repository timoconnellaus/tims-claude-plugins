---
topic: tanstack-start/framework/react/guide/observability
title: Observability
description: Observability is a critical aspect of modern web development,
  enabling you to monitor, trace, and debug your application's performance and
  errors. TanStack Start provides built-in patterns for observa
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/guide/observability.md
tags:
  - tanstack-start
  - framework
---
