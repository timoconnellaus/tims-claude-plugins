---
topic: tanstack-start/framework/react/tutorial/fetching-external-api
title: Fetching External Api
description: This guide demonstrates how to integrate external API calls into
  your TanStack Start application using route loaders. We will use TMDB API to
  fetch popular movies using TanStack Start and understand h
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/tutorial/fetching-external-api.md
tags:
  - tanstack-start
  - framework
---
