---
topic: tanstack-start/framework/react/tutorial/reading-writing-file
title: Install uuid for generating unique IDs
description: This tutorial will guide you through building a complete full-stack
  application using TanStack Start. You'll create a DevJokes app where users can
  view and add developer-themed jokes, demonstrating ke
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/tutorial/reading-writing-file.md
tags:
  - tanstack-start
  - framework
---
