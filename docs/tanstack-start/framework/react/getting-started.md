---
topic: tanstack-start/framework/react/getting-started
title: Getting Started
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/getting-started.md
tags:
  - tanstack-start
  - framework
---
