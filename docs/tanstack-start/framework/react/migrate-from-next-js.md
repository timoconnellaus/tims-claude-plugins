---
topic: tanstack-start/framework/react/migrate-from-next-js
title: Migrate From Next Js
description: This guide provides a step-by-step process to migrate a project
  from the Next.js App Router to **TanStack Start**. We respect the powerful
  features of Next.js and aim to make this transition as smooth
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/migrate-from-next-js.md
tags:
  - tanstack-start
  - framework
---
