---
topic: tanstack-start/framework/react/comparison
title: Comparison
description: Choosing a full-stack React framework? This comparison focuses on
  the **full-stack framework features** that distinguish TanStack Start from
  Next.js and React Router (v7 Framework Mode). > **🚨 IMPORT
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/start/framework/react/comparison.md
tags:
  - tanstack-start
  - framework
---
