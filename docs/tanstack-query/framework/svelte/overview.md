---
topic: tanstack-query/framework/svelte/overview
title: Overview
description: The `@tanstack/svelte-query` package offers a 1st-class API for
  using TanStack Query via Svelte. > Migrating from stores to the runes syntax?
  See the [migration guide](./migrate-from-v5-to-v6).
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/svelte/overview.md
tags:
  - tanstack-query
  - framework
---
