---
topic: tanstack-query/framework/svelte/migrate-from-v5-to-v6
title: Migrate From V5 To V6
description: While Svelte v5 has legacy compatibility with the stores syntax
  from Svelte v3/v4, it has been somewhat buggy and unreliable for this adapter.
  The `@tanstack/svelte-query` v6 adapter fully migrates to
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/svelte/migrate-from-v5-to-v6.md
tags:
  - tanstack-query
  - framework
---
