---
topic: tanstack-query/framework/vue/installation
title: Installation
description: You can install Vue Query via [NPM](https://npmjs.com).
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/vue/installation.md
tags:
  - tanstack-query
  - framework
---
