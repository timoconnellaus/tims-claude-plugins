---
topic: tanstack-query/framework/vue/guides/disabling-queries
title: Disabling Queries
description: "[//]: # 'Example'"
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/vue/guides/disabling-queries.md
tags:
  - tanstack-query
  - framework
---
