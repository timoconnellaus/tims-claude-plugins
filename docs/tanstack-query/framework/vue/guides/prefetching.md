---
topic: tanstack-query/framework/vue/guides/prefetching
title: Prefetching
description: If you're lucky enough, you may know enough about what your users
  will do to be able to prefetch the data they need before it's needed! If this
  is the case, you can use the `prefetchQuery` method to p
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/vue/guides/prefetching.md
tags:
  - tanstack-query
  - framework
---
