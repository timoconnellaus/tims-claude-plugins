---
topic: tanstack-query/framework/vue/guides/suspense
title: Suspense
description: "> NOTE: Suspense mode for Vue Query is experimental, same as Vue's
  Suspense itself. These APIs WILL change and should not be used in production
  unless you lock both your Vue and Vue Query versions to "
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/vue/guides/suspense.md
tags:
  - tanstack-query
  - framework
---
