---
topic: tanstack-query/framework/vue/guides/migrating-to-v5
title: Migrating To V5
description: "[//]: # 'FrameworkSpecificBreakingChanges'"
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/vue/guides/migrating-to-v5.md
tags:
  - tanstack-query
  - framework
---
