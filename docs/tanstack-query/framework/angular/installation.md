---
topic: tanstack-query/framework/angular/installation
title: Installation
description: "> IMPORTANT: This library is currently in an experimental stage.
  This means that breaking changes will happen in minor AND patch releases.
  Upgrade carefully. If you use this in production while in exp"
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/angular/installation.md
tags:
  - tanstack-query
  - framework
---
