---
topic: tanstack-query/framework/angular/typescript
title: Typescript
description: "[//]: # 'TypeInference1'"
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/angular/typescript.md
tags:
  - tanstack-query
  - framework
---
