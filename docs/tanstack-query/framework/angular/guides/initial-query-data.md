---
topic: tanstack-query/framework/angular/guides/initial-query-data
title: Initial Query Data
description: "[//]: # 'Example'"
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/angular/guides/initial-query-data.md
tags:
  - tanstack-query
  - framework
---
