---
topic: tanstack-query/framework/angular/guides/testing
title: Testing
description: Most Angular tests using TanStack Query will involve services or
  components that call `injectQuery`/`injectMutation`. TanStack Query's
  `inject*` functions integrate with [`PendingTasks`](https://angul
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/angular/guides/testing.md
tags:
  - tanstack-query
  - framework
---
