---
topic: tanstack-query/framework/angular/guides/query-cancellation
title: Query Cancellation
description: TanStack Query provides each query function with an [`AbortSignal`
  instance](https://developer.mozilla.org/docs/Web/API/AbortSignal). When a
  query becomes out-of-date or inactive, this `signal` will b
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/angular/guides/query-cancellation.md
tags:
  - tanstack-query
  - framework
---
