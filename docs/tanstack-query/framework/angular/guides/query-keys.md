---
topic: tanstack-query/framework/angular/guides/query-keys
title: Query Keys
description: "[//]: # 'Example'"
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/angular/guides/query-keys.md
tags:
  - tanstack-query
  - framework
---
