---
topic: tanstack-query/framework/angular/guides/disabling-queries
title: Disabling Queries
description: "[//]: # 'Example'"
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/angular/guides/disabling-queries.md
tags:
  - tanstack-query
  - framework
---
