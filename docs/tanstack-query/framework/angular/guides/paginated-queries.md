---
topic: tanstack-query/framework/angular/guides/paginated-queries
title: Paginated Queries
description: "[//]: # 'Example'"
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/angular/guides/paginated-queries.md
tags:
  - tanstack-query
  - framework
---
