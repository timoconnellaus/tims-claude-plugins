---
topic: tanstack-query/framework/angular/guides/infinite-queries
title: Infinite Queries
description: "[//]: # 'Example'"
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/angular/guides/infinite-queries.md
tags:
  - tanstack-query
  - framework
---
