---
topic: tanstack-query/framework/solid/overview
title: Overview
description: Solid Query is the official SolidJS adapter of TanStack Query that
  makes **fetching, caching, synchronizing and updating server state** in your
  web applications a breeze.
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/solid/overview.md
tags:
  - tanstack-query
  - framework
---
