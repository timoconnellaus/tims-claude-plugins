---
topic: tanstack-query/framework/solid/installation
title: Installation
description: You can install Solid Query via [NPM](https://npmjs.com/), or a
  good ol' `<script>` via [ESM.sh](https://esm.sh/).
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/solid/installation.md
tags:
  - tanstack-query
  - framework
---
