---
topic: tanstack-query/framework/solid/quick-start
title: Quick Start
description: The `@tanstack/solid-query` package provides a 1st-class API for
  using TanStack Query with SolidJS.
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/solid/quick-start.md
tags:
  - tanstack-query
  - framework
---
