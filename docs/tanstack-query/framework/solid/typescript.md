---
topic: tanstack-query/framework/solid/typescript
title: Typescript
description: "Solid Query is written in **TypeScript** to make sure the library
  and your projects are type-safe! Things to keep in mind: - Types currently
  require using TypeScript **v4.7** or greater - Changes to t"
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/solid/typescript.md
tags:
  - tanstack-query
  - framework
---
