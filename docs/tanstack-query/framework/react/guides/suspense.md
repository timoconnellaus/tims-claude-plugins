---
topic: tanstack-query/framework/react/guides/suspense
title: Suspense
description: "React Query can also be used with React's Suspense for Data
  Fetching APIs. For this, we have dedicated hooks: -
  [useSuspenseQuery](../reference/useSuspenseQuery.md) -
  [useSuspenseInfiniteQuery](../ref"
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/suspense.md
tags:
  - tanstack-query
  - framework
---
