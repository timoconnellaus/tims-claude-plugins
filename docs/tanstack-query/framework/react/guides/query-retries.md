---
topic: tanstack-query/framework/react/guides/query-retries
title: Query Retries
description: When a `useQuery` query fails (the query function throws an error),
  TanStack Query will automatically retry the query if that query's request has
  not reached the max number of consecutive retries (def
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/query-retries.md
tags:
  - tanstack-query
  - framework
---
