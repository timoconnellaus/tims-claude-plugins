---
topic: tanstack-query/framework/react/guides/migrating-to-v5
title: Migrating To V5
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/migrating-to-v5.md
tags:
  - tanstack-query
  - framework
---
