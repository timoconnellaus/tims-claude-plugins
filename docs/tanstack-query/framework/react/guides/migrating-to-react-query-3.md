---
topic: tanstack-query/framework/react/guides/migrating-to-react-query-3
title: Migrating To React Query 3
description: Previous versions of React Query were awesome and brought some
  amazing new features, more magic, and an overall better experience to the
  library. They also brought on massive adoption and likewise a l
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/migrating-to-react-query-3.md
tags:
  - tanstack-query
  - framework
---
