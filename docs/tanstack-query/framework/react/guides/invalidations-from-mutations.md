---
topic: tanstack-query/framework/react/guides/invalidations-from-mutations
title: Invalidations From Mutations
description: Invalidating queries is only half the battle. Knowing **when** to
  invalidate them is the other half. Usually when a mutation in your app
  succeeds, it's VERY likely that there are related queries in yo
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/invalidations-from-mutations.md
tags:
  - tanstack-query
  - framework
---
