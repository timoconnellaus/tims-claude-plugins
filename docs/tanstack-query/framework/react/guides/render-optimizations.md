---
topic: tanstack-query/framework/react/guides/render-optimizations
title: Render Optimizations
description: "React Query applies a couple of optimizations automatically to
  ensure that your components only re-render when they actually need to. This is
  done by the following means:"
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/render-optimizations.md
tags:
  - tanstack-query
  - framework
---
