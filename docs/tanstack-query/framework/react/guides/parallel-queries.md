---
topic: tanstack-query/framework/react/guides/parallel-queries
title: Parallel Queries
description: '"Parallel" queries are queries that are executed in parallel, or
  at the same time so as to maximize fetching concurrency.'
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/parallel-queries.md
tags:
  - tanstack-query
  - framework
---
