---
topic: tanstack-query/framework/react/guides/testing
title: Testing
description: React Query works by means of hooks - either the ones we offer or
  custom ones that wrap around them. With React 17 or earlier, writing unit
  tests for these custom hooks can be done by means of the [Re
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/testing.md
tags:
  - tanstack-query
  - framework
---
