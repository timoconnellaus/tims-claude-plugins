---
topic: tanstack-query/framework/react/guides/query-cancellation
...
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/query-cancellation.md
tags:
  - tanstack-query
  - framework
---
