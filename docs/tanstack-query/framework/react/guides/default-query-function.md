---
topic: tanstack-query/framework/react/guides/default-query-function
title: Default Query Function
description: If you find yourself wishing for whatever reason that you could
  just share the same query function for your entire app and just use query keys
  to identify what it should fetch, you can do that by prov
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/default-query-function.md
tags:
  - tanstack-query
  - framework
---
