---
topic: tanstack-query/framework/react/guides/advanced-ssr
title: Advanced Ssr
description: Welcome to the Advanced Server Rendering guide, where you will
  learn all about using React Query with streaming, Server Components and the
  Next.js app router. You might want to read the [Server Render
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/advanced-ssr.md
tags:
  - tanstack-query
  - framework
---
