---
topic: tanstack-query/framework/react/guides/network-mode
title: Network Mode
description: TanStack Query provides three different network modes to
  distinguish how [Queries](./queries.md) and [Mutations](./mutations.md) should
  behave if you have no network connection. This mode can be set f
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/network-mode.md
tags:
  - tanstack-query
  - framework
---
