---
topic: tanstack-query/framework/react/guides/disabling-queries
title: Disabling Queries
description: "If you ever want to disable a query from automatically running,
  you can use the `enabled = false` option. The enabled option also accepts a
  callback that returns a boolean. When `enabled` is `false`: "
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/disabling-queries.md
tags:
  - tanstack-query
  - framework
---
