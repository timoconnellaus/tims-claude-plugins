---
topic: tanstack-query/framework/react/guides/paginated-queries
title: Paginated Queries
description: "Rendering paginated data is a very common UI pattern and in
  TanStack Query, it \"just works\" by including the page information in the
  query key: [//]: # 'Example'"
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/paginated-queries.md
tags:
  - tanstack-query
  - framework
---
