---
topic: tanstack-query/framework/react/guides/filters
title: Filters
description: Some methods within TanStack Query accept a `QueryFilters` or
  `MutationFilters` object.
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/filters.md
tags:
  - tanstack-query
  - framework
---
