---
topic: tanstack-query/framework/react/guides/updates-from-mutation-responses
title: Updates From Mutation Responses
description: When dealing with mutations that **update** objects on the server,
  it's common for the new object to be automatically returned in the response of
  the mutation. Instead of refetching any queries for th
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/updates-from-mutation-responses.md
tags:
  - tanstack-query
  - framework
---
