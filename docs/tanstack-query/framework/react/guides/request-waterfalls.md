---
topic: tanstack-query/framework/react/guides/request-waterfalls
title: Request Waterfalls
description: Application performance is a broad and complex area and while React
  Query can't make your APIs faster, there are still things to be mindful about
  in how you use React Query to ensure the best performa
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/guides/request-waterfalls.md
tags:
  - tanstack-query
  - framework
---
