---
topic: tanstack-query/framework/react/typescript
title: Typescript
description: "React Query is now written in **TypeScript** to make sure the
  library and your projects are type-safe! Things to keep in mind: - Types
  currently require using TypeScript **v4.7** or greater - Changes "
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/typescript.md
tags:
  - tanstack-query
  - framework
---
