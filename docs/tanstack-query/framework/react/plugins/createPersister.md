---
topic: tanstack-query/framework/react/plugins/createpersister
title: CreatePersister
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/plugins/createPersister.md
tags:
  - tanstack-query
  - framework
---
