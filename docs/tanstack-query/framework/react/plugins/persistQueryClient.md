---
topic: tanstack-query/framework/react/plugins/persistqueryclient
title: PersistQueryClient
description: This is set of utilities for interacting with "persisters" which
  save your queryClient for later use. Different **persisters** can be used to
  store your client and cache to many different storage laye
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/plugins/persistQueryClient.md
tags:
  - tanstack-query
  - framework
---
