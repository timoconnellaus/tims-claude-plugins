---
topic: tanstack-query/framework/react/plugins/broadcastqueryclient
title: BroadcastQueryClient
description: "> VERY IMPORTANT: This utility is currently in an experimental
  stage. This means that breaking changes will happen in minor AND patch
  releases. Use at your own risk. If you choose to rely on this in p"
version: latest
sourceUrl: https://github.com/tanstack/query/blob/main/docs/framework/react/plugins/broadcastQueryClient.md
tags:
  - tanstack-query
  - framework
---
