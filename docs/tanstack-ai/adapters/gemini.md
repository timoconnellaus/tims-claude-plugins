---
topic: tanstack-ai/adapters/gemini
title: Gemini
description: The Google Gemini adapter provides access to Google's Gemini
  models, including Gemini Pro and Gemini Ultra.
version: latest
sourceUrl: https://github.com/tanstack/ai/blob/main/docs/adapters/gemini.md
tags:
  - tanstack-ai
  - adapters
---
