---
topic: tanstack-ai/adapters/ollama
title: Ollama
description: The Ollama adapter provides access to local models running via
  Ollama, allowing you to run AI models on your own infrastructure.
version: latest
sourceUrl: https://github.com/tanstack/ai/blob/main/docs/adapters/ollama.md
tags:
  - tanstack-ai
  - adapters
---
