---
topic: tanstack-ai/getting-started/quick-start
title: or
description: Get started with TanStack AI in minutes. This guide will walk you
  through creating a simple chat application using the React integration and
  OpenAI adapter.
version: latest
sourceUrl: https://github.com/tanstack/ai/blob/main/docs/getting-started/quick-start.md
tags:
  - tanstack-ai
  - getting-started
---
