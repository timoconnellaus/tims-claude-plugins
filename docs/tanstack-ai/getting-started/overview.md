---
topic: tanstack-ai/getting-started/overview
title: Overview
description: TanStack AI is a lightweight, type-safe SDK for building
  production-ready AI experiences. Its framework-agnostic core provides
  type-safe tool/function calling, streaming responses, and first-class Rea
version: latest
sourceUrl: https://github.com/tanstack/ai/blob/main/docs/getting-started/overview.md
tags:
  - tanstack-ai
  - getting-started
---
