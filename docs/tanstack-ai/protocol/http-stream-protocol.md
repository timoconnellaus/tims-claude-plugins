---
topic: tanstack-ai/protocol/http-stream-protocol
title: Validate each line
description: "HTTP streaming with newline-delimited JSON (NDJSON) is a simpler
  protocol than SSE that sends one JSON object per line. It's useful when: - SSE
  event prefixes add unwanted overhead - You need more con"
version: latest
sourceUrl: https://github.com/tanstack/ai/blob/main/docs/protocol/http-stream-protocol.md
tags:
  - tanstack-ai
  - protocol
---
