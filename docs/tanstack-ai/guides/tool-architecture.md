---
topic: tanstack-ai/guides/tool-architecture
title: Tool Architecture
description: "The TanStack AI tool system provides a powerful, flexible
  architecture for enabling AI agents to interact with external systems: -
  [**Server Tools**](./server-tools) execute securely on the backend wi"
version: latest
sourceUrl: https://github.com/tanstack/ai/blob/main/docs/guides/tool-architecture.md
tags:
  - tanstack-ai
  - guides
---
