---
topic: tanstack-ai/guides/agentic-cycle
title: Agentic Cycle
description: The agentic cycle is the pattern where the LLM repeatedly calls
  tools, receives results, and continues reasoning until it can provide a final
  answer. This enables complex multi-step operations.
version: latest
sourceUrl: https://github.com/tanstack/ai/blob/main/docs/guides/agentic-cycle.md
tags:
  - tanstack-ai
  - guides
---
