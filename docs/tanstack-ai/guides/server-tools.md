---
topic: tanstack-ai/guides/server-tools
title: Server Tools
description: Server tools execute automatically when called by the LLM. They
  have full access to server resources like databases, APIs, and environment
  variables.
version: latest
sourceUrl: https://github.com/tanstack/ai/blob/main/docs/guides/server-tools.md
tags:
  - tanstack-ai
  - guides
---
