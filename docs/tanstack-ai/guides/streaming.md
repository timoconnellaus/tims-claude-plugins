---
topic: tanstack-ai/guides/streaming
title: Streaming
description: TanStack AI supports streaming responses for real-time chat
  experiences. Streaming allows you to display responses as they're generated,
  rather than waiting for the complete response.
version: latest
sourceUrl: https://github.com/tanstack/ai/blob/main/docs/guides/streaming.md
tags:
  - tanstack-ai
  - guides
---
