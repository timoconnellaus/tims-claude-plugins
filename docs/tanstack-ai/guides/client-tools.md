---
topic: tanstack-ai/guides/client-tools
title: Client Tools
description: Client tools execute in the browser, enabling UI updates, local
  storage access, and browser API interactions. Unlike server tools, client
  tools don't have an `execute` function in their server definit
version: latest
sourceUrl: https://github.com/tanstack/ai/blob/main/docs/guides/client-tools.md
tags:
  - tanstack-ai
  - guides
---
