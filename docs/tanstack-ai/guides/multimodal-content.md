---
topic: tanstack-ai/guides/multimodal-content
title: Multimodal Content
description: TanStack AI supports multimodal content in messages, allowing you
  to send images, audio, video, and documents alongside text to AI models that
  support these modalities. When sending messages to AI mod
version: latest
sourceUrl: https://github.com/tanstack/ai/blob/main/docs/guides/multimodal-content.md
tags:
  - tanstack-ai
  - guides
---
