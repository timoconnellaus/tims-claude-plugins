---
topic: tanstack-ai/guides/tool-approval
title: Tool Approval
description: The tool approval flow allows you to require user approval before
  executing sensitive tools, giving users control over actions like sending
  emails, making purchases, or deleting data. Tools go through
version: latest
sourceUrl: https://github.com/tanstack/ai/blob/main/docs/guides/tool-approval.md
tags:
  - tanstack-ai
  - guides
---
