---
topic: tanstack-ai/guides/connection-adapters
title: Connection Adapters
description: Connection adapters handle the communication between your client
  and server for streaming chat responses. TanStack AI provides built-in
  adapters and supports custom implementations.
version: latest
sourceUrl: https://github.com/tanstack/ai/blob/main/docs/guides/connection-adapters.md
tags:
  - tanstack-ai
  - guides
---
