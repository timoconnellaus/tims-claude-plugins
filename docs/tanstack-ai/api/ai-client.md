---
topic: tanstack-ai/api/ai-client
title: Ai Client
description: Framework-agnostic headless client for managing chat state and streaming.
version: latest
sourceUrl: https://github.com/tanstack/ai/blob/main/docs/api/ai-client.md
tags:
  - tanstack-ai
  - api
---
