---
topic: tanstack-router/framework/solid/routing/file-based-routing
title: File Based Routing
description: "[//]: # 'SupportedBundlersList' - [Configuration with
  Vite](#configuration-with-vite) [//]: # 'SupportedBundlersList' [//]: #
  'ConfigurationBundlerVite'"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/solid/routing/file-based-routing.md
tags:
  - tanstack-router
  - framework
---
