---
topic: tanstack-router/framework/solid/installation/with-rspack
title: With Rspack
description: "[//]: # 'BundlerConfiguration' To use file-based routing with
  **Rspack** or **Rsbuild**, you'll need to install the
  `@tanstack/router-plugin` package."
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/solid/installation/with-rspack.md
tags:
  - tanstack-router
  - framework
---
