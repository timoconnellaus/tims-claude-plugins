---
topic: tanstack-router/framework/solid/installation/with-webpack
title: With Webpack
description: "[//]: # 'BundlerConfiguration' To use file-based routing with
  **Webpack**, you'll need to install the `@tanstack/router-plugin` package."
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/solid/installation/with-webpack.md
tags:
  - tanstack-router
  - framework
---
