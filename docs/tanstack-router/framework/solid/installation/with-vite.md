---
topic: tanstack-router/framework/solid/installation/with-vite
title: With Vite
description: "[//]: # 'BundlerConfiguration' To use file-based routing with
  **Vite**, you'll need to install the `@tanstack/router-plugin` package."
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/solid/installation/with-vite.md
tags:
  - tanstack-router
  - framework
---
