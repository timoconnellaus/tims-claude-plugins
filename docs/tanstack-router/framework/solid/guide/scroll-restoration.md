---
topic: tanstack-router/framework/solid/guide/scroll-restoration
title: Scroll Restoration
description: "[//]: # 'ManualRestorationExample'"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/solid/guide/scroll-restoration.md
tags:
  - tanstack-router
  - framework
---
