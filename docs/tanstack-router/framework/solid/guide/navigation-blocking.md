---
topic: tanstack-router/framework/solid/guide/navigation-blocking
title: Navigation Blocking
description: "[//]: # 'HookBasedBlockingExample'"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/solid/guide/navigation-blocking.md
tags:
  - tanstack-router
  - framework
---
