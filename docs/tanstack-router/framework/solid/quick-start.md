---
topic: tanstack-router/framework/solid/quick-start
title: or
description: "[//]: # 'createAppCommand'"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/solid/quick-start.md
tags:
  - tanstack-router
  - framework
---
