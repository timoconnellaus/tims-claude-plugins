---
topic: tanstack-router/framework/react/how-to/drafts/optimize-search-param-performance-draft
title: "DRAFT: Optimize Search Parameter Performance"
description: "**Final Destination:**
  `docs/router/framework/react/how-to/optimize-search-param-performance.md`
  **Progressive Series Position:** Advanced Level (Power User Patterns) - Guide
  #7 **Depends On:** `setup"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/how-to/drafts/optimize-search-param-performance.draft.md
tags:
  - tanstack-router
  - framework
---
