---
topic: tanstack-router/framework/react/how-to/navigate-with-search-params
title: Navigate With Search Params
description: This guide covers updating and managing search parameters during
  navigation using TanStack Router's Link components and programmatic navigation
  methods. **Prerequisites:** [Set Up Basic Search Paramet
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/how-to/navigate-with-search-params.md
tags:
  - tanstack-router
  - framework
---
