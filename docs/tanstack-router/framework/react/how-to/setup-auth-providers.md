---
topic: tanstack-router/framework/react/how-to/setup-auth-providers
title: Setup Auth Providers
description: This guide covers integrating popular authentication services
  (Auth0, Clerk, Supabase) with TanStack Router.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/how-to/setup-auth-providers.md
tags:
  - tanstack-router
  - framework
---
