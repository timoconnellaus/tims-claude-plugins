---
topic: tanstack-router/framework/react/how-to/arrays-objects-dates-search-params
title: Arrays Objects Dates Search Params
description: Learn to handle arrays, objects, dates, and nested data structures
  in search parameters while maintaining type safety and URL compatibility.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/how-to/arrays-objects-dates-search-params.md
tags:
  - tanstack-router
  - framework
---
