---
topic: tanstack-router/framework/react/how-to/deploy-to-production
title: Install Wrangler
description: This guide covers deploying TanStack Router applications to popular
  hosting platforms.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/how-to/deploy-to-production.md
tags:
  - tanstack-router
  - framework
---
