---
topic: tanstack-router/framework/react/how-to/setup-basic-search-params
title: Setup Basic Search Params
description: Learn how to add type-safe, production-ready search parameters to
  your TanStack Router routes using schema validation. This guide covers the
  fundamentals of search parameter validation, reading values
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/how-to/setup-basic-search-params.md
tags:
  - tanstack-router
  - framework
---
