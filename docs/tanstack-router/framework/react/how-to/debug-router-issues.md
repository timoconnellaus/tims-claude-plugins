---
topic: tanstack-router/framework/react/how-to/debug-router-issues
title: Check if route types are being generated
description: This guide covers debugging common TanStack Router problems, from
  route matching failures to navigation issues and performance problems.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/how-to/debug-router-issues.md
tags:
  - tanstack-router
  - framework
---
