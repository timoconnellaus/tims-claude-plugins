---
topic: tanstack-router/framework/react/how-to/setup-rbac
title: Setup Rbac
description: This guide covers implementing role-based access control (RBAC) and
  permission-based routing in TanStack Router applications.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/how-to/setup-rbac.md
tags:
  - tanstack-router
  - framework
---
