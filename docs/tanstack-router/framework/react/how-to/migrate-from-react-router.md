---
topic: tanstack-router/framework/react/how-to/migrate-from-react-router
title: Install TanStack Router
description: This guide provides a step-by-step process to migrate your
  application from React Router v7 to TanStack Router. We'll cover the complete
  migration process from removing React Router dependencies to im
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/how-to/migrate-from-react-router.md
tags:
  - tanstack-router
  - framework
---
