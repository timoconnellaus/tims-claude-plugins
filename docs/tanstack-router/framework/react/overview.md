---
topic: tanstack-router/framework/react/overview
title: Overview
description: "**TanStack Router is a router for building React and Solid
  applications**. Some of its features include: - 100% inferred TypeScript
  support - Typesafe navigation - Nested Routing and layout routes (wi"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/overview.md
tags:
  - tanstack-router
  - framework
---
