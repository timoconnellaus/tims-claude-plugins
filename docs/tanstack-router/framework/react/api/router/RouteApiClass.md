---
topic: tanstack-router/framework/react/api/router/routeapiclass
title: RouteApiClass
description: "> [!CAUTION] > This class has been deprecated and will be removed
  ...
  [`getRouteApi`](./getRouteApiFunction.md) function instead. The `RouteA"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/RouteApiClass.md
tags:
  - tanstack-router
  - framework
---
