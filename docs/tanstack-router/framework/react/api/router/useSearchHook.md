---
topic: tanstack-router/framework/react/api/router/usesearchhook
title: UseSearchHook
description: The `useSearch` method is a hook that returns the current search
  query parameters as an object for the current location. This hook is useful
  for accessing the current search string and query parameter
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/useSearchHook.md
tags:
  - tanstack-router
  - framework
---
