---
topic: tanstack-router/framework/react/api/router/deferfunction
title: DeferFunction
description: "> [!CAUTION] > You don't need to call `defer` manually anymore,
  Promises are handled automatically now. The `defer` function wraps a promise
  with a deferred state object that can be used to inspect th"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/deferFunction.md
tags:
  - tanstack-router
  - framework
---
