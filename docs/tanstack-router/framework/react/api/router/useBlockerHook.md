---
topic: tanstack-router/framework/react/api/router/useblockerhook
title: UseBlockerHook
description: The `useBlocker` method is a hook that [blocks
  navigation](../../guide/navigation-blocking.md) when a condition is met. > ⚠️
  The following new `useBlocker` API is currently _experimental_.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/useBlockerHook.md
tags:
  - tanstack-router
  - framework
---
