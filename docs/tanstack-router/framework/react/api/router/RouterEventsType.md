---
topic: tanstack-router/framework/react/api/router/routereventstype
title: RouterEventsType
description: The `RouterEvents` type contains all of the events that the router
  can emit. Each top-level key of this type, represents the name of an event
  that the router can emit. The values of the keys are the e
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/RouterEventsType.md
tags:
  - tanstack-router
  - framework
---
