---
topic: tanstack-router/framework/react/api/router/getrouteapifunction
title: GetRouteApiFunction
description: The `getRouteApi` function provides type-safe version of common
  hooks like `useParams`, `useSearch`, `useRouteContext`, `useNavigate`,
  `useLoaderData`, and `useLoaderDeps` that are pre-bound to a spec
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/getRouteApiFunction.md
tags:
  - tanstack-router
  - framework
---
