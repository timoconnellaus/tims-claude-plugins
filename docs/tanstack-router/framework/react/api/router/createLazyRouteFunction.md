---
topic: tanstack-router/framework/react/api/router/createlazyroutefunction
title: CreateLazyRouteFunction
description: The `createLazyRoute` function is used for creating a partial
  code-based route route instance that is lazily loaded when matched. This route
  instance can only be used to configure the [non-critical pr
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/createLazyRouteFunction.md
tags:
  - tanstack-router
  - framework
---
