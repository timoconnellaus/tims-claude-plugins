---
topic: tanstack-router/framework/react/api/router/stripsearchparamsfunction
title: StripSearchParamsFunction
description: "`stripSearchParams` is a search middleware that allows to remove
  search params."
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/stripSearchParamsFunction.md
tags:
  - tanstack-router
  - framework
---
