---
topic: tanstack-router/framework/react/api/router/createfileroutefunction
title: CreateFileRouteFunction
description: "The `createFileRoute` function is a factory that can be used to
  create a file-based route instance. This route instance can then be used to
  automatically generate a route tree with the `tsr generate` "
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/createFileRouteFunction.md
tags:
  - tanstack-router
  - framework
---
