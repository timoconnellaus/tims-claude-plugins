---
topic: tanstack-router/framework/react/api/router/notfoundcomponentcomponent
title: NotFoundComponentComponent
description: The `NotFoundComponent` component is a component that renders when
  a not-found error occurs in a route.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/notFoundComponentComponent.md
tags:
  - tanstack-router
  - framework
---
