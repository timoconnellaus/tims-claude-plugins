---
topic: tanstack-router/framework/react/api/router/userouterstatehook
title: UseRouterStateHook
description: The `useRouterState` method is a hook that returns the current
  internal state of the router. This hook is useful for accessing the current
  state of the router in a component. > [!TIP] > If you want to
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/useRouterStateHook.md
tags:
  - tanstack-router
  - framework
---
