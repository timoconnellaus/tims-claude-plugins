---
topic: tanstack-router/framework/react/api/router/routerstatetype
title: RouterStateType
description: "The `RouterState` type represents shape of the internal state of
  the router. The Router's internal state is useful, if you need to access
  certain internals of the router, such as any pending matches, "
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/RouterStateType.md
tags:
  - tanstack-router
  - framework
---
