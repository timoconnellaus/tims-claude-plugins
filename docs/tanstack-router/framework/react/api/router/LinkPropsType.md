---
topic: tanstack-router/framework/react/api/router/linkpropstype
title: LinkPropsType
description: The `LinkProps` type extends the
  [`ActiveLinkOptions`](./ActiveLinkOptionsType.md) and
  `React.AnchorHTMLAttributes<HTMLAnchorElement>` types and contains additional
  props specific to the `Link` compon
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/LinkPropsType.md
tags:
  - tanstack-router
  - framework
---
