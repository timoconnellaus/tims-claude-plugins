---
topic: tanstack-router/framework/react/api/router/routetype
title: RouteType
description: The `Route` type is used to describe a route instance.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/RouteType.md
tags:
  - tanstack-router
  - framework
---
