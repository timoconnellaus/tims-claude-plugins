---
topic: tanstack-router/framework/react/api/router/usechildmatcheshook
title: UseChildMatchesHook
description: The `useChildMatches` hook returns all of the child
  [`RouteMatch`](./RouteMatchType.md) objects from the closest match down to the
  leaf-most match. **It does not include the current match, which can b
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/useChildMatchesHook.md
tags:
  - tanstack-router
  - framework
---
