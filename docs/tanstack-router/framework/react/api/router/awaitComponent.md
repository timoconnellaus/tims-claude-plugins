---
topic: tanstack-router/framework/react/api/router/awaitcomponent
title: AwaitComponent
description: The `Await` component is a component that suspends until the
  provided promise is resolved or rejected. This is only necessary for React 18.
  If you are using React 19, you can use the `use()` hook inst
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/awaitComponent.md
tags:
  - tanstack-router
  - framework
---
