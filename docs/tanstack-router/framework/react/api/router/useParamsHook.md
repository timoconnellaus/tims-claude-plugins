---
topic: tanstack-router/framework/react/api/router/useparamshook
title: UseParamsHook
description: The `useParams` method returns all of the path parameters that were
  parsed for the closest match and all of its parent matches.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/useParamsHook.md
tags:
  - tanstack-router
  - framework
---
