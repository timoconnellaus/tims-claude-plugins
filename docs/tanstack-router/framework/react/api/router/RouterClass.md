---
topic: tanstack-router/framework/react/api/router/routerclass
title: RouterClass
description: "> [!CAUTION] > This class has been deprecated and will be removed
  ...
  [`createRouter`](./createRouterFunction.md) function instead. The `Rout"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/RouterClass.md
tags:
  - tanstack-router
  - framework
---
