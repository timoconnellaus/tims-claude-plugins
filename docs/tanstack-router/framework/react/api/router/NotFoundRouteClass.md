---
topic: tanstack-router/framework/react/api/router/notfoundrouteclass
title: NotFoundRouteClass
description: "> [!CAUTION] > This class has been deprecated and will be removed
  ...
  `notFoundComponent` route option that is present during route configura"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/NotFoundRouteClass.md
tags:
  - tanstack-router
  - framework
---
