---
topic: tanstack-router/framework/react/api/router/redirecttype
title: RedirectType
description: The `Redirect` type is used to represent a redirect action in TanStack Router.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/RedirectType.md
tags:
  - tanstack-router
  - framework
---
