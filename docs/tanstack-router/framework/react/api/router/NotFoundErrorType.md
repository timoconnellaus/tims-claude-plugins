---
topic: tanstack-router/framework/react/api/router/notfounderrortype
title: NotFoundErrorType
description: The `NotFoundError` type is used to represent a not-found error in
  TanStack Router.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/NotFoundErrorType.md
tags:
  - tanstack-router
  - framework
---
