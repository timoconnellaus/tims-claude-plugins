---
topic: tanstack-router/framework/react/api/router/routeroptionstype
title: RouterOptionsType
description: The `RouterOptions` type contains all of the options that can be
  used to configure a router instance.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/RouterOptionsType.md
tags:
  - tanstack-router
  - framework
---
