---
topic: tanstack-router/framework/react/api/router/rootroutewithcontextfunction
title: RootRouteWithContextFunction
description: "> [!CAUTION] > This function is deprecated and will be removed in
  the next major version of TanStack Router. > Please use the
  [`createRootRouteWithContext`](./createRootRouteWithContextFunction.md) fu"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/rootRouteWithContextFunction.md
tags:
  - tanstack-router
  - framework
---
