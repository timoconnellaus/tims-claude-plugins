---
topic: tanstack-router/framework/react/api/router/routertype
title: RouterType
description: The `Router` type is used to describe a router instance.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/RouterType.md
tags:
  - tanstack-router
  - framework
---
