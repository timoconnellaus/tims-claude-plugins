---
topic: tanstack-router/framework/react/api/router/routeclass
title: RouteClass
description: "> [!CAUTION] > This class has been deprecated and will be removed
  ...
  [`createRoute`](./createRouteFunction.md) function instead. The `Route`"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/RouteClass.md
tags:
  - tanstack-router
  - framework
---
