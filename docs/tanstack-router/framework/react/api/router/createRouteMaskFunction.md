---
topic: tanstack-router/framework/react/api/router/createroutemaskfunction
title: CreateRouteMaskFunction
description: The `createRouteMask` function is a helper function that can be
  used to create a route mask configuration that can be passed to the
  `RouterOptions.routeMasks` option.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/createRouteMaskFunction.md
tags:
  - tanstack-router
  - framework
---
