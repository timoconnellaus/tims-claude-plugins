---
topic: tanstack-router/framework/react/api/router/useroutecontexthook
title: UseRouteContextHook
description: The `useRouteContext` method is a hook that returns the current
  context for the current route. This hook is useful for accessing the current
  route context in a component.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/useRouteContextHook.md
tags:
  - tanstack-router
  - framework
---
