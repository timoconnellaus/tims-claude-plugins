---
topic: tanstack-router/framework/react/api/router/routeapitype
title: RouteApiType
description: The `RouteApi` describes an instance that provides type-safe
  versions of common hooks like `useParams`, `useSearch`, `useRouteContext`,
  `useNavigate`, `useLoaderData`, and `useLoaderDeps` that are pre
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/RouteApiType.md
tags:
  - tanstack-router
  - framework
---
