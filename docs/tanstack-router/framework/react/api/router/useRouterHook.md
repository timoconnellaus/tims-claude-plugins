---
topic: tanstack-router/framework/react/api/router/userouterhook
title: UseRouterHook
description: The `useRouter` method is a hook that returns the current instance
  of [`Router`](./RouterType.md) from context. This hook is useful for accessing
  the router instance in a component.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/useRouterHook.md
tags:
  - tanstack-router
  - framework
---
