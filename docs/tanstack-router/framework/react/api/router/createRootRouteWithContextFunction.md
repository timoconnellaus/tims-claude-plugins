---
topic: tanstack-router/framework/react/api/router/createrootroutewithcontextfunction
title: CreateRootRouteWithContextFunction
description: The `createRootRouteWithContext` function is a helper function that
  can be used to create a root route instance that requires a context type to be
  fulfilled when the router is created.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/api/router/createRootRouteWithContextFunction.md
tags:
  - tanstack-router
  - framework
---
