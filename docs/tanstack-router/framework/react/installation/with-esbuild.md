---
topic: tanstack-router/framework/react/installation/with-esbuild
title: With Esbuild
description: "[//]: # 'BundlerConfiguration' To use file-based routing with
  **Esbuild**, you'll need to install the `@tanstack/router-plugin` package."
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/installation/with-esbuild.md
tags:
  - tanstack-router
  - framework
---
