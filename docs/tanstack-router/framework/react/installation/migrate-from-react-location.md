---
topic: tanstack-router/framework/react/installation/migrate-from-react-location
title: Migrate From React Location
description: Before you begin your journey in migrating from React Location,
  it's important that you have a good understanding of the [Routing
  Concepts](../routing/routing-concepts.md) and [Design Decisions](../de
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/installation/migrate-from-react-location.md
tags:
  - tanstack-router
  - framework
---
