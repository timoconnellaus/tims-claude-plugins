---
topic: tanstack-router/framework/react/installation/migrate-from-react-router
title: Migrate From React Router
description: "**_If your UI is blank, open the console, and you will probably
  have some errors that read something along the lines of `cannot use
  'useNavigate' outside of context` . This means there are React Route"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/installation/migrate-from-react-router.md
tags:
  - tanstack-router
  - framework
---
