---
topic: tanstack-router/framework/react/installation/manual
title: or
description: To set up TanStack Router manually in a React project, follow the
  steps below. This gives you a bare minimum setup to get going with TanStack
  Router using both file-based route generation and code-bas
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/installation/manual.md
tags:
  - tanstack-router
  - framework
---
