---
topic: tanstack-router/framework/react/comparison
title: Comparison
description: Choosing a routing solution? This side‑by‑side comparison
  highlights key features, trade‑offs, and common use cases to help you quickly
  evaluate how each option fits your project’s needs. While we aim
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/comparison.md
tags:
  - tanstack-router
  - framework
---
