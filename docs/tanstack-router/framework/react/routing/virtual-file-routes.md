---
topic: tanstack-router/framework/react/routing/virtual-file-routes
title: Virtual File Routes
description: "> We'd like to thank the Remix team for [pioneering the concept of
  virtual file routes](https://www.youtube.com/watch?v=fjTX8hQTlEc&t=730s).
  We've taken inspiration from their work and adapted it to w"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/routing/virtual-file-routes.md
tags:
  - tanstack-router
  - framework
---
