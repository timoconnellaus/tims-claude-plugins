---
topic: tanstack-router/framework/react/llm-support
title: Llm Support
description: TanStack Router's documentation is integrated into its NPM module,
  making it available to install as LLM assistance rules. These rules can be
  integrated into various editors to provide context-aware h
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/llm-support.md
tags:
  - tanstack-router
  - framework
---
