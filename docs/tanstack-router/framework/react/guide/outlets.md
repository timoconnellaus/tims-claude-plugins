---
topic: tanstack-router/framework/react/guide/outlets
title: Outlets
description: Nested routing means that routes can be nested within other routes,
  including the way they render. So how do we tell our routes where to render
  this nested content?
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/outlets.md
tags:
  - tanstack-router
  - framework
---
