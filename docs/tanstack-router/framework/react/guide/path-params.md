---
topic: tanstack-router/framework/react/guide/path-params
title: Path Params
...
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/path-params.md
tags:
  - tanstack-router
  - framework
---
