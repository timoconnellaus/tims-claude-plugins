---
topic: tanstack-router/framework/react/guide/data-loading
title: Data Loading
description: Data loading is a common concern for web applications and is
  related to routing. When loading a page for your app, it's ideal if all of the
  page's async requirements are fetched and fulfilled as early
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/data-loading.md
tags:
  - tanstack-router
  - framework
---
