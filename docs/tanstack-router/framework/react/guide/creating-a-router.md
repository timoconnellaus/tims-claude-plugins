---
topic: tanstack-router/framework/react/guide/creating-a-router
title: Creating A Router
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/creating-a-router.md
tags:
  - tanstack-router
  - framework
---
