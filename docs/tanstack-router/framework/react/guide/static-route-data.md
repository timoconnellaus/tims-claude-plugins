---
topic: tanstack-router/framework/react/guide/static-route-data
title: Static Route Data
description: When creating routes, you can optionally specify a `staticData`
  property in the route's options. This object can literally contain anything
  you want as long as it's synchronously available when you cr
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/static-route-data.md
tags:
  - tanstack-router
  - framework
---
