---
topic: tanstack-router/framework/react/guide/automatic-code-splitting
title: Automatic Code Splitting
description: "The automatic code splitting feature in TanStack Router allows you
  to optimize your application's bundle size by lazily loading route components
  and their associated data. This is particularly useful "
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/automatic-code-splitting.md
tags:
  - tanstack-router
  - framework
---
