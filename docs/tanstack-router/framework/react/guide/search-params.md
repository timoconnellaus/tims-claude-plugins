---
topic: tanstack-router/framework/react/guide/search-params
title: Search Params
description: "Similar to how TanStack Query made handling server-state in your
  React and Solid applications a breeze, TanStack Router aims to unlock the
  power of URL search params in your applications. > 🧠 If you "
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/search-params.md
tags:
  - tanstack-router
  - framework
---
