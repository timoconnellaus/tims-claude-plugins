---
topic: tanstack-router/framework/react/guide/preloading
title: Preloading
description: Preloading in TanStack Router is a way to load a route before the
  user actually navigates to it. This is useful for routes that are likely to be
  visited by the user next. For example, if you have a li
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/preloading.md
tags:
  - tanstack-router
  - framework
---
