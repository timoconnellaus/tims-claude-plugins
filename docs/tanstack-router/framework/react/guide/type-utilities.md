---
topic: tanstack-router/framework/react/guide/type-utilities
title: Type Utilities
description: Most types exposed by TanStack Router are internal, subject to
  breaking changes and not always easy to use. That is why TanStack Router has a
  subset of exposed types focused on ease of use with the in
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/type-utilities.md
tags:
  - tanstack-router
  - framework
---
