---
topic: tanstack-router/framework/react/guide/code-splitting
title: Code Splitting
description: "Code splitting and lazy loading is a powerful technique for
  improving the bundle size and load performance of an application. - Reduces
  the amount of code that needs to be loaded on initial page load "
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/code-splitting.md
tags:
  - tanstack-router
  - framework
---
