---
topic: tanstack-router/framework/react/guide/render-optimizations
title: Render Optimizations
description: "TanStack Router includes several optimizations to ensure your
  components only re-render when necessary. These optimizations include:"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/render-optimizations.md
tags:
  - tanstack-router
  - framework
---
