---
topic: tanstack-router/framework/react/guide/external-data-loading
title: External Data Loading
description: "> [!IMPORTANT] > This guide is geared towards external state
  management libraries and their integration with TanStack Router for data
  fetching, ssr, hydration/dehydration and streaming. If you haven't"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/external-data-loading.md
tags:
  - tanstack-router
  - framework
---
