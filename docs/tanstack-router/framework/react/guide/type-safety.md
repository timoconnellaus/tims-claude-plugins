---
topic: tanstack-router/framework/react/guide/type-safety
title: Type Safety
description: TanStack Router is built to be as type-safe as possible within the
  limits of the TypeScript compiler and runtime. This means that it's not only
  written in TypeScript, but that it also **fully infers t
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/type-safety.md
tags:
  - tanstack-router
  - framework
---
