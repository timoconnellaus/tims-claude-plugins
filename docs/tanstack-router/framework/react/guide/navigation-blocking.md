---
topic: tanstack-router/framework/react/guide/navigation-blocking
title: Navigation Blocking
description: "Navigation blocking is a way to prevent navigation from happening.
  This is typical if a user attempts to navigate while they: - Have unsaved
  changes - Are in the middle of a form - Are in the middle o"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/navigation-blocking.md
tags:
  - tanstack-router
  - framework
---
