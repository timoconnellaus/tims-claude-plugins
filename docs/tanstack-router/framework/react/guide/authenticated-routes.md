---
topic: tanstack-router/framework/react/guide/authenticated-routes
title: Authenticated Routes
description: Authentication is an extremely common requirement for web
  applications. In this guide, we'll walk through how to use TanStack Router to
  build protected routes, and how to redirect users to login if th
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/authenticated-routes.md
tags:
  - tanstack-router
  - framework
---
