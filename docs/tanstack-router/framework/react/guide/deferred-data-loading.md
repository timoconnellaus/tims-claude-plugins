---
topic: tanstack-router/framework/react/guide/deferred-data-loading
title: Deferred Data Loading
description: TanStack Router is designed to run loaders in parallel and wait for
  all of them to resolve before rendering the next route. This is great most of
  the time, but occasionally, you may want to show the u
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/framework/react/guide/deferred-data-loading.md
tags:
  - tanstack-router
  - framework
---
