---
topic: tanstack-router/integrations/query
title: or
description: "> [!IMPORTANT] > This integration automates SSR
  dehydration/hydration and streaming between TanStack Router and TanStack
  Query. If you haven't read the standard [External Data
  Loading](../framework/re"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/integrations/query.md
tags:
  - tanstack-router
  - integrations
---
