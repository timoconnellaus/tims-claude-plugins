---
topic: tanstack-router/api/file-based-routing
title: File Based Routing
description: TanStack Router's file-based routing is quite flexible and can be
  configured to suit your project's needs.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/api/file-based-routing.md
tags:
  - tanstack-router
  - api
---
