---
topic: tanstack-router/eslint/create-route-property-order
title: Create Route Property Order
description: "For the following functions, the property order of the passed in
  object matters due to type inference: - `createRoute` - `createFileRoute` -
  `createRootRoute` - `createRootRouteWithContext` The correc"
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/eslint/create-route-property-order.md
tags:
  - tanstack-router
  - eslint
---
