---
topic: tanstack-router/eslint/eslint-plugin-router
title: Eslint Plugin Router
description: TanStack Router comes with its own ESLint plugin. This plugin is
  used to enforce best practices and to help you avoid common mistakes.
version: latest
sourceUrl: https://github.com/tanstack/router/blob/main/docs/router/eslint/eslint-plugin-router.md
tags:
  - tanstack-router
  - eslint
---
